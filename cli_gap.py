...
def main():
    ...
    parser.add_argument('--entity_entity', action='store_true')
    parser.add_argument('--entity_relation', action='store_true')
    parser.add_argument('--relation_entity', action='store_true')
    parser.add_argument('--relation_relation', action='store_true')
    
    parser.add_argument("--type_encoding", action='store_true')
